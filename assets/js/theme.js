...
// Toggle between light and dark theme settings (the "system" stage is intentionally removed).
...
// With no stored choice (or a legacy "system" value), default to the OS preference once,
// stored as a concrete "light"/"dark" so the toggle stays binary.
